  ...
  return (
    <div className='h-[340px] w-full flex'>
      ...
      <div className='lg:w-[50%] h-full w-full text-center lg:text-start'>
        ...
        <h1 className='text-4xl font-bold'>The Most Realistic AI Voce Cloning <br /> & Text to Speech for</h1>
        <h1 className='text-4xl font-bold text-indigo-800'>Various Content</h1>
